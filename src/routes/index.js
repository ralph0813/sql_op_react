...
const ListDB = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/List/ListDB'))
const ListTable = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/List/ListTable'))
const ListDetail = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/List/ListDetail'))

const EditDB = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/Edit/EditDB'))
const EditTable = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/Edit/EditTable'))
const EditDetail = loadable(() => import(/* webpackChunkName: 'index' */ '@/views/SQL/Edit/EditDetail'))
